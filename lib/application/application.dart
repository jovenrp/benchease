...
import 'package:benchease/application/app_theme.dart';
import 'package:benchease/application/providers/blocs_provider.dart';
import 'package:benchease/application/providers/repositories_provider.dart';
import 'package:benchease/application/theme.dart';
...
import '../core/data/services/utils/flutter_user_agent.dart';
import '../core/domain/models/errors/api_error.dart';
import '../core/domain/repositories/local_repository/memory_repository.dart';
import '../core/domain/repositories/local_repository/secured_local_repository.dart';
import '../core/domain/repositories/local_repository/unsecured_local_repository.dart';
import '../core/domain/utils/interceptors/api_interceptor.dart';
import '../core/domain/utils/interceptors/proxy_api_interceptor.dart';
import '../core/domain/utils/platform/actiontrak_platform_impl.dart';
import '../core/presentation/widgets/theme_state.dart';
...
class _ApplicationState extends State<Application> {
  ...
  void initState() {
    ...
    themeState = getThemeState(false, AppTheme.lighTheme, AppTheme.lighTheme);
  ...
  Widget build(BuildContext context) {
    ...
    final List<SingleChildWidget> blocs = BlocsProvider.provide(
      dio: _dio,
      apiUrl: 'https://brm.kierquebral.com',
      kierUrl: 'https://go.kierquebral.com',
      sheenaUrl:
