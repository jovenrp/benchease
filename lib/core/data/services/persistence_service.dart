...
import 'package:benchease/core/domain/interfaces/local_repository.dart';
import 'package:benchease/core/domain/models/persistence_value_container.dart';
...
class PersistenceService {
  ...
  StringValueContainer get accessToken => StringValueContainer(
        'keys.bencheEaseAccessToken',
        _securedStorage,
      );
  ...
  BoolValueContainer get isDemoFinished => BoolValueContainer(
        'keys.isDemoFinished',
        _unsecuredStorage,
      );
